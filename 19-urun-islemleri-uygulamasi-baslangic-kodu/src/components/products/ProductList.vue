        ...
        <div class="col-12 mb-5 card mt-5 shadow">
            <div class="card-body">
                ...
                <table class="table table-hover table-striped table-bordered" v-if="getProducts.length > 0">
                    ...
                    <tbody>
                        <tr v-for="product1 in getProducts" :key="product1">
                            <td class="align-middle text-center"><span class="badge badge-info"> {{product.key}} </span>
                            </td>
                            <td class="align-middle text-center"> {{product.title}} </td>
                            <td class="align-middle text-center" :class="getCountClasses(product.counts)"> {{product.count}} </td>
